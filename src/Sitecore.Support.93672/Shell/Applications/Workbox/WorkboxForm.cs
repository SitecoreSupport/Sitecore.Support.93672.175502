...
namespace Sitecore.Support.Shell.Applications.Workbox
{
    public class WorkboxForm : BaseForm
    {
        ...
        protected class StateItems
        {
            ...
            /// </summary>
            public System.Collections.Generic.IEnumerable<string> CommandIds
            {
                get;
                set;
            }
        ...
        public void Comment(ClientPipelineArgs args)
        {
            ...
            ItemUri itemUri = new ItemUri((Context.ClientPage.ServerProperties["id"] ?? string.Empty).ToString(), Language.Parse(Context.ClientPage.ServerProperties["language"] as string), Sitecore.Data.Version.Parse(Context.ClientPage.ServerProperties["version"] as string), Context.ContentDatabase);
            ...
            if (args.Result != null && args.Result.Length > 2000)
            {
                ...
                try
                {
                    ...
                    if (workflowFromPage != null)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            WorkflowUIHelper.ExecuteCommand(item, workflowFromPage, Context.ClientPage.ServerProperties["command"] as string, commentFields, completionCallback);
                        }
                    }
                }
        ...
        protected void Refresh(System.Collections.Generic.Dictionary<string, string> urlArguments)
        {
            ...
            {
                foreach (System.Collections.Generic.KeyValuePair<string, string> current in urlArguments)
                {
        ...
        protected virtual DataUri[] GetItems(WorkflowState state, IWorkflow workflow)
        {
            ...
            System.Collections.ArrayList arrayList = new System.Collections.ArrayList(items.Length);
            DataUri[] array = items;
            for (int i = 0; i < array.Length; i++)
            {
            ...
            if (workflowProvider != null)
            {
                ...
                if (workflow != null)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        Context.ClientPage.ServerProperties["workflowid"] = text;
        ...
        private void SendAll(Message message)
        {
            ...
            if (workflowProvider != null)
            {
                ...
                if (workflow != null)
                {
                    ...
                    if (state == null)
                    {
                        string arg_6B_0 = string.Empty;
                    }
                    else
                    {
                        string arg_75_0 = state.DisplayName;
                    }
                    bool flag = false;
                    DataUri[] array = items;
                    for (int i = 0; i < array.Length; i++)
        ...
        private void SendSelected(Message message)
        {
            ...
            if (workflowProvider != null)
            {
                ...
                if (workflow != null)
                {
                    ...
                    {
                        if (text != null && text.StartsWith("check_", System.StringComparison.InvariantCulture))
                        {
                            ...
                            Item item = Context.ContentDatabase.Items[array[0], Language.Parse(array[1]), Sitecore.Data.Version.Parse(array[2])];
                            if (item != null)
                            {
        ...
        private void WorkflowCompleteStateItemCount(WorkflowPipelineArgs args)
        {
            ...
            System.Collections.Generic.Dictionary<string, string> urlArguments = workflowFromPage.GetStates().ToDictionary((WorkflowState state) => state.StateID, (WorkflowState state) => this.Offset[state.StateID].ToString());
